...
<head>
    <meta charset="UTF-8">
    <title>User Profile - Upvoted Posts</title>
...
<div class="profile-container">
    ...
    <div class="main-content">
        ...
        <div class="profile-content">
            <h2>Bài viết bạn đã upvote</h2>

            <c:choose>
                <c:when test="${not empty upvotedPosts}">
                    <c:forEach var="post" items="${upvotedPosts}">
                        <div class="post-card" onclick="location.href='postDetails?postID=${post.postID}'"
                            ...
                            <div class="post-content">
                                ...
                                <div class="post-actions">
                                    <div class="action-item">
                                        <i class="fas fa-arrow-up" style="color: green;"></i> ${post.score}
                                    </div>
                                    <div class="action-item">
                ...
                <c:otherwise>
                    <div class="no-posts">
                        ...
                        <p>u/${sessionScope.user.username} chưa upvote bài viết nào.</p>
                    </div>
                </c:otherwise>
            </c:choose>
        </div>
