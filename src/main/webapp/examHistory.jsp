...
<div class="container">
    ...
    <div class="exam-history">
        ...
        <c:forEach var="examTaken" items="${examTakens}" varStatus="status">
            <c:set var="exam" value="${exams[status.index]}" />
            <div class="exam-item">
                <div class="date-bubble">
                        ${examTaken.formattedDateCreated}
                </div>
                ...
                <div class="exam-info">
                    <div class="exam-info-item">
                        ...
                        <span>Ngày làm: ${examTaken.formattedDateCreated}</span>
                    </div>
                    <div class="exam-info-item">
                ...
                <a href="${pageContext.request.contextPath}/exam?action=result&examTakenID=${examTaken.examTakenID}&examID=${examTaken.examID}&skill=${examTaken.eQuesType}" class="view-detail">
