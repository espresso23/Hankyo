    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 main-content">
            <div class="header-gradient mb-4 d-flex align-items-center justify-content-between">
                <h2 class="mb-0">Quản lý expert</h2>
            </div>
            <div class="card">
                <div class="card-body">
...
<script>
fetch('/Hankyo/admin/experts')
    .then(res => res.json())
    .then(data => {
        const tb = document.getElementById('expertTable');
        tb.innerHTML = '';
