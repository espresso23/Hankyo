...
public class FacebookLoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            // Get access token and user information from Facebook
            String accessToken = FacebookLogin.getToken(code);
            User user = FacebookLogin.getUserInfo(accessToken);
            ...
            System.out.println("Facebook Login Successful: " + user.displayInfo()); // Log thông tin user
