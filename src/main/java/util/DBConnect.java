...
public class DBConnect {
    ...
    private static final String DB_URL = "jdbc:sqlserver://DESKTOP-G5AU876;databaseName=Hankyo1;encrypt=true;trustServerCertificate=true;useUnicode=true&characterEncoding=UTF-8";
