...
public class DBConnect {
    ...
    private static final String DB_URL = "jdbc:sqlserver://localhost:1433;databaseName=Hankyo1;encrypt=true;trustServerCertificate=true;useUnicode=true&characterEncoding=UTF-8";
